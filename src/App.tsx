...
function App() {
  ...
  const [selectedPlatform,setSelectPlaform] = useState<platform | null>(null);
  ...
  return (
    ...
    >
      ...
      <GridItem area="main">
        ...
        <PlatformSelector selectedPlatform={selectedPlatform} onSelecedPlaform={(platform)=>setSelectPlaform(platform)} />
